...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="content">
                <h4 class="motto">Create Account</h4>
                <div class="subscribe">
                    <center>
                        <form>
                            <div class="form-group">
                                <label for="email">Email Address</label>
                                <input type="email" class="form-control" id="email" aria-describedby="email" required="" placeholder="Enter email">
                            </div>
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="username" class="form-control" id="username" required="" placeholder="Username">
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" id="password" required="" placeholder="Password">
                            </div>
                            <button type="submit" class="btn cstmbtn btn-info">Submit</button>
                        </form>
                    </center>
                </div>
            </div>
